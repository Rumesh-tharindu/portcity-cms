...
<div class="card-body">
    ...
    {!! Form::hidden('page_id', 2) !!}
    {!! Form::hidden('section', 'public-registry') !!}

    <div class="tab-content">

        <div class="tab-pane fade active show" id="custom-tabs-en" role="tabpanel" aria-labelledby="custom-tabs-en-tab">
            @include('backend.public-registry.type.includes.localization', [ 'locale' => 'en' ])
        </div>
...
@include('backend.theme.components.ajax-form-submit', [ 'redirectUrl' => 'admin.public-registry.type.index' ])
@endpush
