...
<div class="card-body">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade active show" id="custom-tabs-en" role="tabpanel" aria-labelledby="custom-tabs-en-tab">
            @include('backend.about.faq-type.includes.localization', [ 'locale' => 'en' ])
        </div>
...
@push('scripts')
@include('backend.theme.components.ajax-form-submit', [ 'redirectUrl' => 'admin.about.faq.type.index' ])
@endpush
